...
$pdf->Cell(40, 10, 'Phone Number', 1, 0, 'L', true);
$pdf->Cell(80, 10, 'Email', 1, 1, 'L', true);
...
foreach ($result as $customer) {
    $pdf->Cell(20, 10, $customer['customer_id'], 1, 0, 'L');
    $pdf->Cell(50, 10, $customer['name'], 1, 0, 'L');
    $pdf->Cell(40, 10, $customer['phone_number'], 1, 0, 'L');
    $pdf->Cell(80, 10, $customer['email'], 1, 1, 'L');
}

// Output the PDF
$pdf->Output('D', 'customer_list.pdf');
